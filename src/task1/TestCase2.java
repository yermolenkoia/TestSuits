...
public class TestCase2 {
  ...
  public void testCase2() throws Exception {
    ...
    // ERROR: Caught exception [ERROR: Unsupported command [captureEntirePageScreenshot | D:\Screenshots\screen2.png | ]]
    driver.findElement(By.cssSelector("a[title=\"German\"]")).click();
    // ERROR: Caught exception [ERROR: Unsupported command [captureEntirePageScreenshot | D:\Screenshots\screen3.png | ]]
